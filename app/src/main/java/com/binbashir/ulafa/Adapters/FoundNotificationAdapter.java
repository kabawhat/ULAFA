...
public class FoundNotificationAdapter extends RecyclerView.Adapter<FoundNotificationAdapter.ViewHolder> {
    ...
    public FoundNotificationAdapter(ArrayList<Notification_Item> itemArrayList, Context context) {
    ...
    @NonNull
    @Override
    public FoundNotificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                                  int viewType) {
        // passing our layout file for displaying our card item
        return new FoundNotificationAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.found_notication_item, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull FoundNotificationAdapter.ViewHolder holder, int position) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            text_username = itemView.findViewById(R.id.found_notification_item_txt_item_username);
            text_date_time = itemView.findViewById(R.id.found_notification_item_txt_item_date_time);
            text_admno = itemView.findViewById(R.id.found_notification_item_txt_item_adm_no);
            text_message = itemView.findViewById(R.id.found_notification_item_txt_item_message);
            imageView_image = itemView.findViewById(R.id.found_notification_item_image_item_count);
            btn_call_founder = itemView.findViewById(R.id.found_notification_item_btn_call);
            btn_delete_founder = itemView.findViewById(R.id.found_notification_item_btn_delete);
        }

        public void setImageLetter(String firstletter, int color) {
            drawableh = TextDrawable.builder()
                    .buildRound(firstletter, color);
            ImageView rounded_image = itemView.findViewById(R.id.found_notification_item_image_item_count);
