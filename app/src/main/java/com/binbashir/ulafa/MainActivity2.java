...
public class MainActivity2 extends AppCompatActivity implements MovieListAdapter.MovieClickInterface {
    ...
    public void addItem(View view) {
        Movie movie = new Movie("10","Avenger's", "9");
